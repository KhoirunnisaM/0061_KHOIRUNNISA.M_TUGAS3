...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql_update = "UPDATE tb_users SET nama=?, alamat=?, nohp=?, foto=?, jenis_kelamin=?, email=? WHERE id=?";

    $stmt = $conn->prepare($sql_update);
    $stmt->bind_param('ssssssi', $nama, $alamat, $nohp, $fotoBaru, $jenis_kelamin, $email, $id);
